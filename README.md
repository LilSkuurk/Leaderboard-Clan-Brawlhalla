...
Dans votre serveur Discord, utilisez la commande suivante :  
/classement  

Le bot générera un classement des membres du clan avec leur **meilleur ELO** :  

![Classement Embed](https://media.giphy.com/media/3o7abKhOpu0NwenH3O/giphy.gif)  
...
. ├── index.js # Fichier principal du bot ├── package.json # Dépendances du projet ├── Procfile # Configuration pour Heroku ├── .env # Variables sensibles (non incluses dans le repo) ├── README.md # Documentation complète
